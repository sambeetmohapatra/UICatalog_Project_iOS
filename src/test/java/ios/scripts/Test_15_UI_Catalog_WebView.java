...
import ios.pageObjects.WebView_MyStore_POM;
...
//Step 8 : Go Back to Home Screen 
	...
	public static Iterator<Object[]> getdata_Test_15_UI_Catalog_WebView() throws Exception
	{
	return Dataprovider_testdata.commonmethod_for_testdata(EXCEL_SHEET_UI_CATALOG,"Test_15_UI_Catalog_WebView");
