...
public class ExcelReadWrite {
	...
	public static String getExcelData(String sheetName, int rowNum,int colNum) throws EncryptedDocumentException, InvalidFormatException, IOException{
		  FileInputStream fis = new FileInputStream(Automation_Constants.TEST_DATA_FILE);
		...
		public static int getColumnCount(String sheetName) throws EncryptedDocumentException, InvalidFormatException, IOException{
			FileInputStream fis = new FileInputStream(Automation_Constants.TEST_DATA_FILE);
			Workbook wb = WorkbookFactory.create(fis);
			Sheet sh = wb.getSheet(sheetName);
